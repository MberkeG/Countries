...
class UlkeDetaySayfasi extends StatelessWidget {
  ...
  Widget _buildTumDetaylar() {
    return Padding(
      ...
      child: Column(
        children: [
          _buildDetayRow("Country Name: ", _ulke.isim),
          _buildDetayRow("Capital City: ", _ulke.baskent),
          _buildDetayRow("Region: ", _ulke.bolge),
          _buildDetayRow("Population: ", _ulke.nufus.toString()),
          _buildDetayRow("Language: ", _ulke.dil),
        ],
      ),
    );
  }
